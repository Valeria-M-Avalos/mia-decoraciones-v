...
<section class="relative py-32 bg-gradient-to-br from-pink-100 via-pink-50 to-yellow-50 overflow-hidden">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div class="text-9xl mb-6 animate-bounce">{{ $evento['emoji'] }}</div>
...
<section class="py-20 bg-white">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="bg-gradient-to-br from-pink-50 to-white rounded-3xl p-12 shadow-xl border border-pink-100">
            <h2 class="text-4xl font-bold text-gray-800 mb-6 text-center">Nuestra Visión</h2>
...
<section class="py-20 bg-gradient-to-br from-pink-50 to-yellow-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16">
            <h2 class="text-4xl font-bold text-gray-800 mb-4">Galería de {{ $evento['titulo'] }}</h2>
            ...
            <div class="group relative overflow-hidden rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
                ...
                <div class="absolute inset-0 bg-gradient-to-t from-black/70 via-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end">
                    <div class="p-6 w-full">
                        <h3 class="text-white text-xl font-bold mb-2">{{ $imagen->titulo }}</h3>
...
@php
    // Filtramos las imágenes que tienen un código de incrustación de Instagram
    $videos = $imagenes->filter(fn($img) => !empty($img->embed_code_instagram));
@endphp
...
<section class="py-20 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16">
            <h2 class="text-4xl font-bold text-gray-800 mb-4">Videos e Historias de {{ $evento['titulo'] }}</h2>
            <p class="text-xl text-gray-600">Mira nuestro trabajo en Instagram.</p>
        </div>
...
<section class="py-20 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="bg-gradient-to-br from-white to-pink-50 rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all border border-pink-100">
                <div class="w-16 h-16 bg-gradient-to-br from-pink-500 to-pink-600 rounded-full flex items-center justify-center mb-6 mx-auto">
...
<section class="py-20 bg-gradient-to-br from-pink-50 to-yellow-50">
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="bg-gradient-to-r from-pink-500 to-pink-600 rounded-3xl p-12 text-white text-center shadow-2xl">
