    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div class="space-y-8">
                ...
                <div class="space-y-6">
                    <!-- WhatsApp -->
                    <div class="flex items-start space-x-4 p-6 bg-gradient-to-br from-green-50 to-white rounded-2xl shadow-md">
                        <div class="w-12 h-12 bg-green-500 rounded-full flex items-center justify-center flex-shrink-0">
                            <span class="text-2xl">📱</span>
                        </div>
                        <div>
                            <h3 class="font-semibold text-gray-800 text-lg mb-1">WhatsApp</h3>
                            <p class="text-gray-600">+54 9 11 XXXX-XXXX</p>
                            <a href="https://wa.me/5491XXXXXXXXX" target="_blank" class="text-green-600 hover:text-green-700 font-medium">Enviar mensaje</a>
                        </div>
                    </div>
                    
                    <!-- Email -->
                    <div class="flex items-start space-x-4 p-6 bg-gradient-to-br from-pink-50 to-white rounded-2xl shadow-md">
                    ...
                    <!-- Ubicación -->
                    <div class="flex items-start space-x-4 p-6 bg-gradient-to-br from-blue-50 to-white rounded-2xl shadow-md">
                        <div class="w-12 h-12 bg-blue-500 rounded-full flex items-center justify-center flex-shrink-0">
                            <span class="text-2xl">📍</span>
                        </div>
                        <div>
                            <h3 class="font-semibold text-gray-800 text-lg mb-1">Ubicación</h3>
                            <p class="text-gray-600">Formosa, Argentina</p>
                        </div>
                    </div>
                    
                    <!-- Horarios -->
                    <div class="flex items-start space-x-4 p-6 bg-gradient-to-br from-yellow-50 to-white rounded-2xl shadow-md">
                ...
                <!-- Redes Sociales -->
                <div class="bg-gradient-to-br from-pink-100 to-yellow-50 rounded-2xl p-8">
                    <h3 class="text-xl font-bold text-gray-800 mb-4">Síguenos en Redes</h3>
                    <div class="flex space-x-4">
                        <a href="#" class="w-12 h-12 bg-pink-500 rounded-full flex items-center justify-center text-white hover:bg-pink-600 transition">
